      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Logged in successfully!'); // ✅ fixed
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alert.showAlert)('error', _t.response.data.message); // ✅ err belongs here
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          stripe = Stripe('pk_test_51TCqykBxLeA7jEBOVESfhuMKHQBjMVPWs9LxTmjBZo7WkiDQ5izsUOYWrzVhzIie8N7AGFWRHJYkf5qO7Rz1kxBC00xqkdlbHw'); //1. Get  checkout session from API
          _context.n = 1;
...
try {
  ...
  var passwordDataForm = document.querySelector('.form-user-settings');
  ...
  if (passwordDataForm) passwordDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
